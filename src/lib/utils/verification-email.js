 ...
 */
export function generateVerificationEmail(name, verificationLink) {
...
<head>
    ...
    <title>Verify Your Email - ChessBD</title>
    <!--[if mso]>
    <style type="text/css">
            ...
            <div class="email-body">
                ...
                <div class="info-box">
                    ...
                    <p style="margin:10px 0 0 0">
                        Please verify your email address to complete your account setup and start using ChessBD.
                    </p>
                </div>
                ...
                <p class="text-small">
                    ...
                    <span style="color:#9ca3af;word-break:break-all">${verificationLink}</span>
                </p>
                ...
                <div class="info-box" style="background-color:rgba(245,158,11,0.1);border-left-color:rgba(245,158,11,0.6)">
                    <p style="margin:0">
